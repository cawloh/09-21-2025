...
import { Wine, Package, BarChart2, FileText, LogOut, Menu, X, AlertTriangle, Settings, User, RotateCcw, Bell } from 'lucide-react';
      ...
      >
        ...
        <nav className="flex flex-col gap-2">
          ...
          <div className="mt-6 pt-4 border-t border-gray-200">
            ...
            <NavLink to="/staff/returns" className={navLinkClass} onClick={() => setIsMobileMenuOpen(false)}>
